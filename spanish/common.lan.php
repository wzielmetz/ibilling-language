...
$_L['Account'] = 'Cuenta';
$_L['Date'] = 'Fecha';
$_L['Financial_Balances'] = 'Balances Financieros';
$_L['Add_New_Account'] = 'Agregar Nueva Cuenta';
$_L['Manage_Accounts'] = 'Manejar Cuenta';
$_L['initial_balance'] = 'Balance Inicial';
$_L['account_created_successfully'] = 'Cuenta Creada Satisfactoriamente';
$_L['account_updated_successfully'] = 'Cuenta Actualizada Satisfactoriamente';
$_L['account_already_exist'] = 'La Cuenta ya Existe';
$_L['system'] = 'Sistema';
$_L['Total'] = 'Total';
$_L['Account_Not_Found'] = 'Cuenta No Encontrada';
$_L['ref_help'] = 'e.g. ID de la Transaccion, Cheque No.';
...
$_L['Payment Method'] = 'Metodo de Pago';
$_L['Ref'] = 'Ref';
$_L['Status'] = 'Estatus';
$_L['Uncategorized'] = 'Sin categorizar';
$_L['transaction_added_successfully'] = 'Transacción agregado con éxito';
$_L['Add_Expense'] = 'Añadir Gasto';
$_L['Payee'] = 'Beneficiario';
$_L['description_error'] = 'Una Descripcion Valida es Requerida';
$_L['Transfer'] = 'Transfererencia';
$_L['From'] = 'De';
$_L['To'] = 'Para';
$_L['Select An Account'] = 'Selecciona una Cuenta';
$_L['same_account_error'] = 'No se puede transferir entre la misma cuenta';
$_L['Transaction_Not_Found'] = 'Transaccion no encontrada';
$_L['transaction_delete_successful'] = 'Transaccion eliminada con exito';
$_L['account_delete_successful'] = 'Cuenta eliminada con exito';
$_L['transaction_update_successful'] = 'Transaccion actualizada con exito';
$_L['Number_of_Payment'] = 'Numero de Pagos';
...
$_L['Yearly'] = 'Anual';
$_L['Once_Only'] = 'Solo una Ves';
$_L['Edit_Option'] = 'Editar Opcion';
$_L['Edit_Single_Occurrence'] = 'Edite Ocurrencia Individual';
$_L['Delete_Single_Occurrence'] = 'Eliminar Ocurrencia Individuale';
$_L['Edit_All_Occurrence'] = 'Editar todas las Ocurrencias';
$_L['Delete_All_Occurrence'] = 'Eliminar todas la Ocurrencias';
$_L['Manage'] = 'Administrar';
$_L['Confirm'] = 'Confirmar';
$_L['Enter_Transaction'] = 'Entre Transaccion';
$_L['Payment_Cleared'] = 'Pago Realizado';
$_L['an_error_occured'] = 'Ha Ocurrido un error';
$_L['name_exist_error'] = 'El Nombre ya existe';
$_L['account_title_length_error'] = 'El Titulo de la Cuenta debe de ser de 3 a 100 caracteres';
$_L['tr_delete_warning'] = 'Deleting Transaction can not be undone. Current Balance with associated account will be adjusted. ';
$_L['frequency_error'] = 'Frecuencia Invalida o Numero de Pago';
$_L['name_error'] = 'Nombre requerido';
